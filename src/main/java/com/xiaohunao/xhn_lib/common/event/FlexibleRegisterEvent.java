...
public abstract class FlexibleRegisterEvent extends Event {
    /**
     * 注册后事件，在资源注册完成后触发
     *
     * @param <T> 资源类型
     */
    public static class After<T> extends FlexibleRegisterEvent {
     ...
     * @param <T> 资源类型
     */
    public static class Before<T> extends FlexibleRegisterEvent implements ICancellableEvent {
        private final ResourceLocation location;
        private final T value;
        private final MappedRegistry<T> registry;
